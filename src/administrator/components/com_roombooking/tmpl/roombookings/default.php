...
if ($saveOrder && !empty($items)) {
	$saveOrderingUrl = 'index.php?option=com_roombooking&task=roombookings.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_roombooking&view=roombookings'); ?>" method="post"
	...
	<div class="row">
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				...
				<?php else: ?>
						<table class="table itemList" id="roombookingList">
									...
									?>
										<tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
											...
											<td class="article-status text-center">
												<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'roombookings.', $canChange, 'cb'); ?>
											</td>
												...
												<div class="break-word">
													<?php if ($canEdit): ?>
															<a class="hasTooltip d-inline-flex align-items-center gap-1"
																href="<?php echo Route::_('index.php?option=com_roombooking&task=roombooking.edit&id=' . $item->id); ?>"
